...
- This document supports D01.01, [D01.01_SAR_General_Computational_Pipeline_Spec_V1.1_2026-07-27.md](D01.01_SAR_General_Computational_Pipeline_Spec_V1.1_2026-07-27.md).
- This document should be read with D02.01, [D02.01_SAR_Computational_Class_and_Object_Model_V1_2026-07-27.md](D02.01_SAR_Computational_Class_and_Object_Model_V1_2026-07-27.md).
...
- `sar_edge`: edge transport/frame contracts for constrained capture nodes (for example, ESP32).
- `sar_acquisition`: ingest adapters, source connectors, and raw-reference emission.
...
1. Component diagram for L0-L6 distributed boundaries (edge capture plus ingest).
